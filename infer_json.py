...
if __name__ == '__main__':
    ...
    #pretrained = "./outputs/vitbase_retrieval/model_0003185.pdmodel" # 6epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0004778.pdmodel" # 9epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0006371.pdmodel" # 12epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0007964.pdmodel" # 15epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0009557.pdmodel" # 18epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0011150.pdmodel" # 21epoch
    #pretrained =  "./outputs/vitbase_retrieval/model_0012743.pdmodel" # 24epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0014336.pdmodel" # 27epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0015929.pdmodel" # 30epoch
    #pretrained = "./outputs/vitbase_retrieval/model_0020708.pdmodel" # 39epoch
